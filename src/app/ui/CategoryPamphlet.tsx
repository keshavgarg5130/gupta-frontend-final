...
const CategoryPamphlet = async ({ categoryName, billboardId }: { categoryName: string, billboardId: string }) => {
    ...
    return (<a href={'/' + categoryName} className="flex flex-col items-center justify-center gap-1 w-3/4 md:w-1/3 lg:w-2/5 overflow-hidden md:border rounded-lg md:p-10">
