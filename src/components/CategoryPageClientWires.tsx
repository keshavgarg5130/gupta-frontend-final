...
import poles from "@/app/interfaces/poles";
            ...
            <div className="flex flex-col lg:flex-row w-full max-w-[1280px] gap-6 py-4">
                ...
                {(showFilters || isDesktop) && (
                    ...
                    >
                        ...
                        {/* Poles Filter */}
                        <div className="mb-4">
                            <div className="text-sm font-semibold text-gray-700 mb-2">Core</div>
                        ...
                        <div>
                            <div className="text-sm font-semibold text-gray-700 mb-2">Area (mm²)</div>
                            <div className="flex flex-wrap gap-2">
